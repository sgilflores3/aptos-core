...
pub enum MVCodeOutput<M, X> {
    /// Arc to the executable corresponding to the latest module, and an indicator
    /// whether the executable corresponds to a storage-version module.
    Executable((Arc<X>, bool)),
