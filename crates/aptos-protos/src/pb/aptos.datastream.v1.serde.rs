...
// @generated
impl serde::Serialize for OnChainDataSummaryRequest {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("aptos.datastream.v1.OnChainDataSummaryRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for OnChainDataSummaryRequest {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = OnChainDataSummaryRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.datastream.v1.OnChainDataSummaryRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<OnChainDataSummaryRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(OnChainDataSummaryRequest {
                })
            }
        }
        deserializer.deserialize_struct("aptos.datastream.v1.OnChainDataSummaryRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for OnChainDataSummaryResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.datastream.v1.OnChainDataSummaryResponse", len)?;
        if self.chain_id != 0 {
...
impl<'de> serde::Deserialize<'de> for OnChainDataSummaryResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = OnChainDataSummaryResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.datastream.v1.OnChainDataSummaryResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<OnChainDataSummaryResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(OnChainDataSummaryResponse {
                    chain_id: chain_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("aptos.datastream.v1.OnChainDataSummaryResponse", FIELDS, GeneratedVisitor)
    }
}
