...
use aptos_protos::transaction::v1::{Event as ProtoEvent, EventKey, MoveType};
...
pub fn convert_move_type(event_type: MoveType) -> String {
    "".to_string()
}
...
impl Event {
    pub fn from_event(
        ...
        Event {
            account_address: event.key.unwrap().account_address,
            creation_number: event.key.unwrap().creation_number as i64,
