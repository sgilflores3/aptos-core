...
// use aptos_api_types::{DeleteModule, MoveModule as ProtoMoveModule, MoveModuleBytecode, WriteModule};
...
impl MoveModule {
    pub fn from_write_module(
        ...
        let parsed_data = Self::convert_move_module_bytecode(&write_module.data.unwrap());
        Self {
            transaction_version,
    ...
    pub fn from_delete_module(
        ...
        Self {
            ...
            transaction_block_height,
            write_set_change_index,
            name: delete_module.module.unwrap().name.to_string(),
    ...
    pub fn convert_move_module_bytecode(
       ...
       Some(Self::convert_move_module(mmb.abi.as_ref().unwrap(), mmb.bytecode))
    }
